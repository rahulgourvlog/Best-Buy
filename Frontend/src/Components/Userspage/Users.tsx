...
import { UserDiv } from "./userStyled";
  ...
  return (
    <UserDiv>
      <div className="links">
        <a href="/">Home</a>
        <div>
          <svg className="arrow userIcons" viewBox="0 0 28 28">
      ...
      <div className="userPages">
        <div className="userContent">
          <div>
            <div>
              <div className="svg_div">
                <svg className="userIcons" viewBox="0 0 32 32">
              ...
              <div className="content_Div">
                <div>
                  <h3 className="contentHeading">Order History</h3>
                  <p>
          ...
          <div>
            <div>
              <div className="svg_div">
                <svg className="userIcons" viewBox="0 0 36 36">
              ...
              <div className="content_Div">
                <div>
                  <h3 className="contentHeading">Payment Methods</h3>
                  <p>
                    Save and manage your payment details for a fast checkout.
                  </p>
                  <p className="_2bzyQ">
                    <span className="_1K-xQ">
                      <span className=""></span>
          ...
          <div>
            <div>
              ...
              <div className="content_Div">
                <div>
                  <h3 className="contentHeading">Addresses</h3>
                  <p>Add your preferred addresses and choose a favourite.</p>
                  <p className="_3Ydag">
                    <span className="undefined DBbtb">
                      <span className="u0-a3"></span>
                      <span>Add a shipping address.</span>
                    </span>
                  </p>
                </div>
                <div>
                  <span>Your shipping addresses</span>
                  <svg className="userIcons" viewBox="0 0 32 32">
                    <path d="M20.5,16a1,1,0,0,1-.29.74l-6.91,7a1,1,0,0,1-1.48,0,1.06,1.06,0,0,1,0-1.49L17.92,16,11.79,9.82a1.06,1.06,0,0,1,0-1.49,1,1,0,0,1,1.48,0l6.91,7A1,1,0,0,1,20.5,16Z"></path>
                  </svg>
                </div>
          ...
          <div>
            <div>
              <div className="svg_div">
                <svg className="userIcons" fill="black" viewBox="0 0 32 32">
              ...
              <div className="content_Div">
                <div>
                  <h3 className="contentHeading">Personal Details</h3>
                  <p>
